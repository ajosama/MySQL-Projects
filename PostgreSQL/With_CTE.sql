...
/*2.For the region with the largest sales total_amt_usd, how many total
orders were placed?*/
...
/*3.For the account that purchased the most (in total over their lifetime as a customer)
